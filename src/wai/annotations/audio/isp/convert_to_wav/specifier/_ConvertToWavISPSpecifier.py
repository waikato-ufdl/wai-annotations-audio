...
class ConvertToWavISPSpecifier(ProcessorStageSpecifier):
    """
    Converts mp3/flac/ogg to wav.
    """
    @classmethod
    def description(cls) -> str:
        return "Converts mp3/flac/ogg to wav."
    ...
    def domain_transfer_function(
        ...
        if input_domain is SpeechDomainSpecifier:
            ...
            raise Exception(
                f"ConvertToWavISPSpecifier only handles the following domains: "
